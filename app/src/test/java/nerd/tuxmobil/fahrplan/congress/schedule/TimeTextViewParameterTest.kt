...
class TimeTextViewParameterTest {
    ...
    @Test
    fun `parametersOf returns 20 view parameters for a session crossing the daylight saving time`() {
        ...
        parameters[8].assert(R.layout.time_layout, "02:00") // Clock turns to 03:00 summer time
